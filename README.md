...
- Kim – Project Manager
- Kim – Research & Security
- Kim – Front End
- Del – JavaScript
- Del – UI
- Del – Testing & Documentation
...
Del - JavaScript Developer (task is to confirm JS is connected)
Link script.js to index.html (GitHub)
Add: Open browser → check console → confirm it works

Del - UI Developer (task is to design direction)
...
Kim - Research and Security Lead (task is to create research outline)
